...
namespace PrimoProgettoBlazor.Migrations
{
    ...
    [Migration("20251230213542_quarta")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrimoProgettoBlazor.Components.Classi.Entities.AttaccoPerk", b =>
                {
                    b.Property<int>("AttaccoId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AttaccoId", "PerkId");

                    b.HasIndex("PerkId");

                    b.ToTable("AttacchiPerks");
                });
            ...
            modelBuilder.Entity("PrimoProgettoBlazor.Components.Classi.Entities.Keyword", b =>
                {
                    ...
                    b.Property<int>("CategoriaKeywordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoriaKeywordId");

                    b.ToTable("Keywords");
                });

            modelBuilder.Entity("PrimoProgettoBlazor.Components.Classi.Entities.Perk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrimoProgettoBlazor.Components.Classi.Entities.AttaccoPerk", b =>
                {
                    b.HasOne("PrimoProgettoBlazor.Components.Classi.Entities.Attacco", "Attacco")
                        .WithMany("AttacchiPerks")
                        .HasForeignKey("AttaccoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PrimoProgettoBlazor.Components.Classi.Entities.Perk", "Perk")
                        .WithMany("AttacchiPerks")
                        .HasForeignKey("PerkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Attacco");
            ...
            modelBuilder.Entity("PrimoProgettoBlazor.Components.Classi.Entities.Keyword", b =>
                {
                    b.HasOne("PrimoProgettoBlazor.Components.Classi.Entities.CategoriaKeyword", "CategoriaKeyword")
                        .WithMany("Keywords")
                        .HasForeignKey("CategoriaKeywordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CategoriaKeyword");
                });
